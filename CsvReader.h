...
public:
	...
	structures::SortedSequenceTable<std::string, Vek*>* nacitajVek(std::string nazovSuboru) {
		...
		for (std::string item : *texty) {
			...
			std::string kodUJ = "";
			structures::ArrayList<int>* vekMuzi = new ArrayList<int>;
			structures::ArrayList<int>* vekZeny = new ArrayList<int>;
